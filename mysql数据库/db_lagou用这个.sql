...
CREATE TABLE `admin`  (
  ...
  UNIQUE INDEX `UK_775atqwkcr2t6m8fyocxro333`(`admin_name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, '2020-07-02 22:41:01', '2020-07-17 18:57:37', '拉勾网管理员', '254540457@qq.com', '20200708/1594201189905.jpg', '13753929485', '123456', 1);
...
CREATE TABLE `company`  (
  ...
  `founder_name` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `founder_photo` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `founder_position` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKdy4v2yb46hefqicjpyj7b7e4s`(`user_id`) USING BTREE,
...
CREATE TABLE `education_background`  (
  ...
  `user_id` bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKfjmjepb8jchkn9nw92q0gj1l`(`user_id`) USING BTREE,
...
CREATE TABLE `expect_work`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK2kpbn1nwuixp9d8il9jyrst2l`(`user_id`) USING BTREE,
...
INSERT INTO `operater_log` VALUES (247, '2020-07-17 18:57:32', '2020-07-17 18:57:32', '修改了管理员信息：【Admin [adminName=拉勾网管理员, password=123456, headPic=20200708/1594201189905.jpg, sex=2, mobile=13753929485, email=254540457@qq.com]】。', '【拉勾网管理员】：');
INSERT INTO `operater_log` VALUES (248, '2020-07-17 18:57:37', '2020-07-17 18:57:37', '修改了管理员信息：【Admin [adminName=拉勾网管理员, password=123456, headPic=20200708/1594201189905.jpg, sex=1, mobile=13753929485, email=254540457@qq.com]】。', '【拉勾网管理员】：');
...
INSERT INTO `operater_log` VALUES (256, '2020-12-10 22:47:33', '2020-12-10 22:47:33', '登录了拉勾网后台管理系统。', '【拉勾网管理员】：');
INSERT INTO `operater_log` VALUES (257, '2020-12-11 00:27:24', '2020-12-11 00:27:24', '登录了拉勾网后台管理系统。', '【拉勾网管理员】：');
...
CREATE TABLE `position`  (
  ...
  `type` varchar(18) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKkpqfp6ontwcnqpkrfwv02iw1y`(`company_id`) USING BTREE,
...
CREATE TABLE `position_category`  (
  ...
  `_parent_id` bigint(20) NULL DEFAULT NULL,
  `parent_id` bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKfa2drl4ultklu8022uwenvfbh`(`parent_id`) USING BTREE,
...
CREATE TABLE `project_experience`  (
  ...
  `user_id` bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK6mjj5tpthn13i66qsn48e0kbs`(`user_id`) USING BTREE,
...
INSERT INTO `project_experience` VALUES (3, '2020-07-18 11:25:38', '2020-07-18 11:25:38', '上网址：https://www.baidu.com/product/details.html?pid=366', '01', '2016', 'springboot框架博客发布系统', '项目负责人', '05', '2015', 10);
...
CREATE TABLE `resume`  (
  ...
  `company_id` bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKfs3x0i2rlgf11kqrgd22185mj`(`position_id`) USING BTREE,
  INDEX `FKiqntisdlc7ta7sjr6d8rj5ae2`(`user_id`) USING BTREE,
  INDEX `FK681rm6lwm57pvwir58nqboosr`(`company_id`) USING BTREE,
...
CREATE TABLE `user`  (
  ...
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `work_experience` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '2020-07-11 16:12:19', '2020-12-10 22:57:41', '344245001@qq.com', '12345678', '20200712/1594541168216.jpg', '13753929485', 1, 0, '林哥哥', '热爱编程', '3年', '硕士');
INSERT INTO `user` VALUES (2, '2020-07-11 16:13:13', '2020-07-13 21:42:36', '254540457@qq.com', '12345678', 'common/default_img.jpg', '', 1, 1, '腾讯招聘者', NULL, '10年以上', '博士');
...
CREATE TABLE `work_experience`  (
  ...
  `user_id` bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKhnxjamc0hrv0uok9w7aayk6kk`(`user_id`) USING BTREE,
...
CREATE TABLE `work_show`  (
  ...
  `user_id` bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKiagbp8nnl01v528v8uuf79lod`(`user_id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `work_show` VALUES (1, '2020-07-13 13:46:12', '2020-12-10 22:57:41', '微信小程序学生宿舍设备报修app设计', 'https://www.shuangyulin.com/article/1337.html', 1);
